...
onBeforeMount(() => {
  axios
      ...
      .then((response) => {
        ...
        filterPreview.value = response.data.filterPreview === "true";
        filterRework.value = response.data.filterRework === "true";
